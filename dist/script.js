...
window.addEventListener('DOMContentLoaded', function () {
  //скрипты запускаются только после готовности ВDOM
  "use strict";
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.decoration_slider', '.no_click', '.decoration_content > div > div', 'after_click'); //строгое соответствие,чтоб был именно див, верстка такая

  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.balcon_icons', '.balcon_icons_img', '.big_img > img', 'do_image_more', 'inline-block'); //увеличение картинки окон при нажатии на маленькие эскизы
...
var changeModalState = function changeModalState(state) {
  //заполняю modalState разными данными
...
var checkNumInputs = function checkNumInputs(selector) {
  ...
  numInputs.forEach(function (item) {
    //проверка, исправление вводимых в инпуты данных
...
var forms = function forms() {
  //получаю данные с сайта,отправляю на сервер
  ...
  var message = {
    //создаю сообщения,которые будут выходить во время взаимодействия с сервером
    loading: 'Загрузка...',
    ...
    return regeneratorRuntime.async(function postData$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            //асинхронная операция...отправка запроса
            document.querySelector('.status').textContent = message.loading;
            _context.next = 3;
            return regeneratorRuntime.awrap(fetch(url, {
              //рес присвоится тольо после получается ответа от сервера
              method: "POST",
              body: data
            }));
  ...
  var clearInputs = function clearInputs() {
    //функция очищения инпутов,после отправления на сервер
  ...
  form.forEach(function (item) {
    ...
    item.addEventListener('submit', function (e) {
      ...
      var statusMessage = document.createElement('div'); //сообщение с оповещениями

      statusMessage.classList.add('status');
      item.appendChild(statusMessage); //показываю статус сообщения пользователю

      var formData = new FormData(item); //собираю все данные и отправляю на сервер в видео формы
      ...
      .then(function (res) {
        ...
        //оно выполнится в любом случае,даже если с ошибкой закончится
...
var modals = function modals() {
  //алгоритм открывания модальных окон
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        if (e.target) {
          //выключаю действие по умолчанию //тк нажимать буду не только на кнопки,но и на ссылки и тд
          e.preventDefault();
        }
    ...
    modal.addEventListener('click', function (e) {
      //закрытие при нажатии на любом месте
      if (e.target === modal && closeClickOverlay) {
        //если нажимаю в любом месте помимо модального окна,оно закрывается
        windows.forEach(function (item) {
          item.style.display = 'none';
        });
        modal.style.display = "none";
  ...
  function showModalByTime(selector, time) {
    //через какое то время пребывания на сайте запускается модальное окно
    setTimeout(function () {
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_close', false); // showModalByTime('.popup', 60000);//через 60 сек запускается модальное окно
};
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  function hideTabContent() {
    ...
    tab.forEach(function (item) {
      //у каждого таба убираю активКласс у ненужных табов
  ...
  header.addEventListener('click', function (e) {
    ...
    target.parentNode.classList.contains(tabSelector.replace(/\./, ""))) {
      ...
      tab.forEach(function (item, i) {
        //определяю на какой именно таб нажат по номеру индекса
...
/* harmony import */ var slick_carousel__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(slick_carousel__WEBPACK_IMPORTED_MODULE_1__);
 //импортирую jquery из nodeModules

 //импортируб сликкарусель///это плагин jquery для создания слайдера
